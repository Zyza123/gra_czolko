...
class _EditGenreState extends ConsumerState<EditGenre> {
  ...
  void processData(String uid, String oldFileName) {
    ...
    // Przykład użycia
    addGenreToFirebaseStorage(lines, uid,oldFileName); // Wywołanie funkcji z poprzedniego przykładu
  }


  Future<void> addGenreToFirebaseStorage(List<String> elements, String Uuid, String oldFileName) async {
    ...
    final oldfileNameF = '${oldFileName.toLowerCase().replaceAll(' ', '')}.json'; // Formatowanie starej nazwy pliku
